...
let koreaPlayer = 양궁선수(점수: BehaviorSubject<Int>(value: 10))
let americaPlayer = 양궁선수(점수: BehaviorSubject<Int>(value: 8))
...
olimpic.onNext(koreaPlayer)
koreaPlayer.점수.onNext(10)

olimpic.onNext(americaPlayer)
koreaPlayer.점수.onNext(10)
americaPlayer.점수.onNext(9)
