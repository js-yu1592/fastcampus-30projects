...
class ViewController: UIViewController {
    ...
    let appKeyId = "7ebc7734dc3a26afb1175d5b3760e122"
    ...
    private func getCurrentWeather(cityName: String) {
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/weather?q=\(cityName)&appid=\(self.appKeyId)") else { return }
