...
extension ProfileViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setup(with: UIImage(systemName: "heart")!)
...
private extension ProfileViewController {
    ...
    @objc func didTapRightBarButtonItem() {
        ...
        [
            UIAlertAction(title: "회원 정보 변경", style: .default) { _ in print("select 회원 정보 변경") },
            UIAlertAction(title: "탈퇴하기", style: .destructive) { _ in print("select 탈퇴하기") },
            UIAlertAction(title: "닫기", style: .cancel) { _ in print("select 닫기") }
